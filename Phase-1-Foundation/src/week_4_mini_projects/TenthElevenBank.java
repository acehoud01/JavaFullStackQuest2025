...
public class TenthElevenBank {
    ...
    public TenthElevenBank() {
        ...
        loadAccounts(); // Load first, no test data
    }
    ...
    public static void main(String[] args) {
        ...
        bank.saveAccounts(); // Save after load—just to test
    }
}
